...
urlpatterns = patterns('',
		...
		url(r'^verify_consultation/(?P<diog_id>\d+)/(?P<ill_id>\d+)/$', views.verify_consultation, name='verify_consultation'),
		...
		url(r'^users/feedbacks/$','doct_admin.views.feedbacks', name="view_patient_user"),
